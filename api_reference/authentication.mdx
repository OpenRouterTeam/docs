...
You can view, rename, disable, or delete existing keys at any time on the [API keys settings page](https://openrouter.ai/settings/keys). To do the same programmatically, see [Management API keys](/guides/overview/auth/management-api-keys).
