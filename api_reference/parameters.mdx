...
Anthropic Messages API callers set `output_config.effort` directly. See [Reasoning with the Anthropic Messages API](/guides/best-practices/reasoning-tokens#anthropic-messages-api).