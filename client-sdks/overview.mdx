...
- [TypeScript SDK reference](https://github.com/OpenRouterTeam/typescript-sdk)
- [Python SDK reference](https://github.com/OpenRouterTeam/python-sdk)
- [Go SDK reference](https://github.com/OpenRouterTeam/go-sdk)
