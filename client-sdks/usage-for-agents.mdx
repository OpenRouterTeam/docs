...
canonicalUrl: https://openrouter.ai/docs/client-sdks/usage-for-agents
og:site_name: OpenRouter Documentation
og:title: 'Usage for Agents | OpenRouter Client SDKs'
og:description: >-
  Add OpenRouter Client SDKs skills to AI coding assistants like Claude Code, Cursor,
  GitHub Copilot, and more. Enable your AI to code with the OpenRouter Client SDKs.
og:image: >-
