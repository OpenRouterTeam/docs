...
seoTitle: OAuth | OpenRouter TypeScript SDK
canonicalUrl: 'https://openrouter.ai/docs/client-sdks/typescript/api-reference/oauth'
...
'og:image': >-
  https://openrouter.ai/dynamic-og?title=OAuth%20-%20TypeScript%20SDK&description=OAuth%20method%20reference
'og:image:width': 1200
'og:image:height': 630
