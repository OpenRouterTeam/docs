...
seoTitle: APIKeys | OpenRouter TypeScript SDK
canonicalUrl: 'https://openrouter.ai/docs/client-sdks/typescript/api-reference/apikeys'
...
'og:image': >-
  https://openrouter.ai/dynamic-og?title=APIKeys%20-%20TypeScript%20SDK&description=APIKeys%20method%20reference
'og:image:width': 1200
'og:image:height': 630
