...
seoTitle: Guardrails | OpenRouter TypeScript SDK
canonicalUrl: 'https://openrouter.ai/docs/client-sdks/typescript/api-reference/guardrails'
...
'og:image': >-
  https://openrouter.ai/dynamic-og?title=Guardrails%20-%20TypeScript%20SDK&description=Guardrails%20method%20reference
'og:image:width': 1200
'og:image:height': 630
