...
seoTitle: StreamEvents Type | OpenRouter TypeScript SDK
canonicalUrl: 'https://openrouter.ai/docs/client-sdks/typescript/api-reference/models/streamevents'
'og:site_name': OpenRouter Documentation
'og:title': StreamEvents Type | OpenRouter TypeScript SDK
'og:description': >-
  StreamEvents type reference for the OpenRouter TypeScript SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://openrouter.ai/dynamic-og?title=StreamEvents%20-%20TypeScript%20SDK&description=StreamEvents%20type%20definition
'og:image:width': 1200
'og:image:height': 630
