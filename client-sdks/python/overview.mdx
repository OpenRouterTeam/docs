---
title: Python SDK
description: Official OpenRouter Python SDK documentation
seoTitle: OpenRouter Python SDK | Complete Documentation
canonicalUrl: 'https://openrouter.ai/docs/client-sdks/python'
