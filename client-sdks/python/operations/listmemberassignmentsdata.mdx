...
seoTitle: ListMemberAssignmentsData | OpenRouter Python SDK
canonicalUrl: 'https://openrouter.ai/docs/client-sdks/python/operations/listmemberassignmentsdata'
'og:site_name': OpenRouter Documentation
'og:title': ListMemberAssignmentsData | OpenRouter Python SDK
'og:description': >-
  ListMemberAssignmentsData method documentation for the OpenRouter Python SDK.
  Learn how to use this API endpoint with code examples.
'og:image': >-
  https://openrouter.ai/dynamic-og?title=ListMemberAssignmentsData%20-%20Python%20SDK&description=ListMemberAssignmentsData%20method%20reference
'og:image:width': 1200
'og:image:height': 630
