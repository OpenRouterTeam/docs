...
seoTitle: ProviderPreferencesMaxPrice | OpenRouter Python SDK
canonicalUrl: 'https://openrouter.ai/docs/client-sdks/python/components/providerpreferencesmaxprice'
'og:site_name': OpenRouter Documentation
'og:title': ProviderPreferencesMaxPrice | OpenRouter Python SDK
'og:description': >-
  ProviderPreferencesMaxPrice method documentation for the OpenRouter Python
  SDK. Learn how to use this API endpoint with code examples.
'og:image': >-
  https://openrouter.ai/dynamic-og?title=ProviderPreferencesMaxPrice%20-%20Python%20SDK&description=ProviderPreferencesMaxPrice%20method%20reference
'og:image:width': 1200
'og:image:height': 630
