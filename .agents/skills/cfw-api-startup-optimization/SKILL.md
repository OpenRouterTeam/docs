...
- **Fix**: re-land (DEV-823) with an extra hunk in `patches/@openrouter%2Fagent@0.9.0.patch` inlining the `'user'` literal in `esm/lib/turn-context.js`, plus the same fix upstream in typescript-agent.
