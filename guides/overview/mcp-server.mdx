...
canonicalUrl: https://openrouter.ai/docs/guides/overview/mcp-server
...
<Note>
This is a **development helper, not a runtime client.** The tools give your in-editor agent live OpenRouter context; your production app still calls the OpenRouter API directly.
</Note>
...
<Tabs>
  <Tab title="Claude Code">
    ```bash lines
    claude mcp add --transport http openrouter https://openrouter.ai/api/v1/mcp
  ...
  <Tab title="Codex CLI">
    ```bash lines
    codex mcp add openrouter --url https://openrouter.ai/api/v1/mcp
  ...
  <Tab title="Cursor CLI">
    ...
    {
      "mcpServers": {
        "openrouter": { "url": "https://openrouter.ai/api/v1/mcp" }
      }
    }
    ```
  </Tab>
...
- "What video generation models can I use?"
- "Best text-to-speech model? What about speech-to-text?"
- "Cheapest model that can take images as input?"
