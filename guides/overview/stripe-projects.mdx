...
canonicalUrl: https://openrouter.ai/docs/guides/overview/stripe-projects
og:site_name: OpenRouter Documentation
og:title: 'Stripe Projects - Add OpenRouter via Stripe CLI'
og:description: 'Provision OpenRouter API access directly from the Stripe Projects CLI. Get an API key, manage credentials, and access 300+ AI models in seconds.'
...
Your API key works with the full [OpenRouter API](/quickstart), giving you access to 300+ AI models through a single endpoint.
