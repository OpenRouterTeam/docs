...
canonicalUrl: https://openrouter.ai/docs/guides/overview/report-feedback
og:site_name: OpenRouter Documentation
og:title: 'Report Feedback - Submit Bug Reports for Generations'
og:description: 'Learn how to report issues with AI generations on OpenRouter using the Report Feedback feature in the Chatroom and Activity page.'
