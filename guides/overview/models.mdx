...
seoTitle: 'OpenRouter Models | Access 300+ AI Models Through One API'
canonicalUrl: https://openrouter.ai/docs/guides/overview/models
...
Explore and browse 300+ models and providers [on our website](https://openrouter.ai/models), or [with our API](/api/api-reference/models/list-all-models-and-their-properties). You can also subscribe to our [RSS feed](/api/v1/models?use_rss=true) to stay updated on new models.
