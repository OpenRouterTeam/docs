...
canonicalUrl: https://openrouter.ai/docs/guides/features/broadcast/ramp
...
<Frame>
![Search for OpenRouter integration](/assets/guides/features/broadcast/ramp/ramp-search-integration.png)
</Frame>

3. Click the **OpenRouter** integration to view the details, then click **Connect**

<Frame>
![OpenRouter integration detail](/assets/guides/features/broadcast/ramp/ramp-integration-detail.png)
</Frame>
