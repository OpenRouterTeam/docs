...
<Frame>
![BigQuery Datasets](/assets/guides/features/broadcast/bigquery/bigquery-datasets.png)
</Frame>
...
<Frame>
![BigQuery Table Setup](/assets/guides/features/broadcast/bigquery/bigquery-setup-instructions.png)
</Frame>

Once created, the table appears in your dataset:

<Frame>
![BigQuery Dataset Tables](/assets/guides/features/broadcast/bigquery/bigquery-dataset-tables.png)
</Frame>
...
<Frame>
![BigQuery Configuration](/assets/guides/features/broadcast/bigquery/bigquery-config.png)
</Frame>
...
<Frame>
![BigQuery Table Preview](/assets/guides/features/broadcast/bigquery/bigquery-table-preview.png)
</Frame>
