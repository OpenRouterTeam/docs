...
On Anthropic models with a fast sibling (e.g. [`anthropic/claude-opus-5-fast`](https://openrouter.ai/anthropic/claude-opus-5-fast)), it also behaves like Anthropic's native `speed: "fast"` parameter and reroutes to the fast sibling — see [Fast Mode](/cookbook/coding-agents/claude-code-integration#fast-mode).
