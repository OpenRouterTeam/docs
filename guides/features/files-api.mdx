...
[`file_ids` setting](/guides/features/containers#attach-workspace-files).
...
- Files that a sandbox command creates can be downloaded through the
  [container files endpoints](/guides/features/containers#download-container-files),
  ...
  [Save a container file to your workspace](/guides/features/containers#save-a-container-file-to-your-workspace).
- Files that the [files tool](/guides/features/server-tools/files) writes or
...
- [Containers](/guides/features/containers): Load files into a
  sandbox container
