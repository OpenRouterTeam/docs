...
The full schema is documented under [`OpenRouterMetadata`](/agent-sdk/call-model/api-reference) in the OpenAPI spec, including SDK type definitions for [TypeScript](https://github.com/OpenRouterTeam/typescript-sdk) and other generated clients.
