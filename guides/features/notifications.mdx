...
Go to [Settings → Notifications](https://openrouter.ai/settings/notifications).
...
- **API key spend limit.** An API key hits a share of its spend limit.
...
Slack and custom webhook delivery are part of the Enterprise private preview.
