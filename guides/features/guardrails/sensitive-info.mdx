...
- **Single entity type detected** — click **Mark as false positive** directly in the popover.
- **Multiple entity types detected** — the popover links to the generation detail view, where you check the specific entity types that were flagged incorrectly under **Mark as false positive**, then click **Submit**.
