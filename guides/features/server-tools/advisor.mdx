...
og:description: 'Let a fast executor model consult a higher-intelligence advisor model for guidance mid-generation, with any OpenRouter model and optional sub-agent tools.'
