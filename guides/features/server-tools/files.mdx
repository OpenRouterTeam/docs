...
og:description: 'Give any model on OpenRouter the ability to read, write, edit, and list text files in your workspace via the Files API. The model decides when to operate on files — OpenRouter executes the operations server-side.'
