...
| `sleep_after_seconds` | integer | `300` | How long the container stays warm after its last command before sleeping. Idle-based: each command renews the timer. Capped at 14400 (4 hours) |
