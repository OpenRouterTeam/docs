...
The shell server tool is available through the [Responses API](/api_reference/responses/overview) and the [Messages API](/api_reference/messages/overview). Requesting it on the Chat Completions API returns a `400` error.
