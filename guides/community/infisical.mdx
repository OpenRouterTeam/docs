...
canonicalUrl: https://openrouter.ai/docs/guides/community/infisical
...
<Frame>
![OpenRouter Management Keys page showing the Create Management Key button](/assets/guides/community/infisical/infisical-provisioning-keys.png)
</Frame>
