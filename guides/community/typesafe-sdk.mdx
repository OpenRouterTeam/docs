---
title: Jev SDK for TypeScript and Python (TypeSafe SDK)
sidebarTitle: TypeSafe SDK (Jev)
description: Point the official TypeSafe JavaScript or Python SDK at OpenRouter to call Jev with your OpenRouter API key
seoTitle: 'Jev SDK for TypeScript and Python | TypeSafe SDK on OpenRouter'
og:site_name: OpenRouter Documentation
og:title: 'Jev SDK for TypeScript and Python (TypeSafe SDK) - OpenRouter'
og:description: 'Point the official TypeSafe JavaScript or Python SDK at OpenRouter to run Jev and other System One models through the System One API.'
og:image: https://openrouter.ai/dynamic-og?title=Jev%20SDK%20for%20TypeScript%20and%20Python&description=Use%20the%20TypeSafe%20SDK%20with%20your%20OpenRouter%20API%20key
og:image:width: 1200
og:image:height: 630
...
If you would rather call Jev without the TypeSafe SDK, use the [Decisions API](/api/api-reference/alphadecisions/submit-a-decisions-questions-and-answers-request) directly or through the OpenRouter [TypeScript](/client-sdks/typescript/sdks/decisions/README), [Python](/client-sdks/python/sdks/decisions/README), or [Go](/client-sdks/go/sdks/decisions/README) SDK. The [Jev tutorial](/guides/community/jev-tutorial) walks through that path from the first request to a threshold decision.
...
- [Jev documentation hub](/guides/community/jev) for what Jev is, how it differs from a chat model, and every Jev page on OpenRouter
- [Jev model page](https://openrouter.ai/typesafe/jev-1.13) for pricing, context length, and provider details
- [Gate Agent Tool Calls with Jev](/cookbook/building-agents/gate-tool-calls-with-jev) for approving, blocking, or escalating agent tool calls
- [Cut LLM Cost with a Jev-Verified Cascade](/cookbook/evaluate-and-optimize/jev-verified-cascade) for verifying cheap-model answers before escalating
- [Classify and Tag Text at Scale with Jev](/cookbook/evaluate-and-optimize/jev-classification) for batch labeling with Choice categories and Noul tags
- [Classify Reddit and YouTube Comments with Jev](/cookbook/evaluate-and-optimize/classify-reddit-comments-with-jev) for scoring scraped comments on relevance and sentiment
- [Auto-Approve Coding Agent Permission Prompts with Jev](/cookbook/coding-agents/auto-approve-permission-prompts-with-jev) for answering Claude Code, Codex, Cursor, and OpenCode permission prompts with a Noul threshold
