...
canonicalUrl: https://openrouter.ai/docs/guides/community/replit
og:site_name: OpenRouter Documentation
og:title: 'Replit Integration - Add OpenRouter API Key to Replit'
og:description: 'Add your OpenRouter API key to Replit to access 300+ AI models in Replit Agent and your Replit apps. Covers BYOK setup and project Secrets.'
