---
title: Ori environment variables
description: Every environment variable Ori reads, what it accepts, and where an administrator can set it fleet-wide
seoTitle: "Ori environment variables | OpenRouter Documentation"
og:site_name: OpenRouter Documentation
og:title: "Ori environment variables"
og:description: "Every environment variable Ori reads, what it accepts, and where an administrator can set it fleet-wide."
nofollow: false
icon: sliders
---
...
| Variable | Accepts | What it does |
| --- | --- | --- |
| `ORI_STATE_DIR` | directory path | Where Ori keeps its local state database. See [where Ori writes files](/guides/ori/files). |
