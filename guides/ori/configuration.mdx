...
description: How to configure Ori, from a single shell to a managed fleet, plus every setting it reads
seoTitle: "Ori configuration | OpenRouter Documentation"
og:site_name: OpenRouter Documentation
og:title: "Ori configuration"
og:description: "How to configure Ori, from a single shell to a managed fleet, plus every setting it reads."
nofollow: false
icon: sliders
---
