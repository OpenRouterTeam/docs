...
description: Store host-bound secrets for a workspace or an intern with the Vault API
seoTitle: "Vault secrets for interns | OpenRouter Documentation"
og:site_name: OpenRouter Documentation
og:title: "Vault secrets for interns"
og:description: "Store host-bound secrets for a workspace or an intern with the Vault API."
nofollow: false
icon: vault
---
...
All routes live under `https://openrouter.ai/api/v1/vault` and take an [API key](/api_reference/authentication) as a bearer token. The full route reference is in the [Vault API reference](/api/api-reference/vault/list-workspace-secrets).
