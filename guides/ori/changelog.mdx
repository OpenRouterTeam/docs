...
Curated release notes for the Ori CLI, newest version first. If you are new to Ori, start with [Ori Eval](/guides/ori/eval), then [Ori Harness](/guides/ori/harness), which also covers installing Ori and running your existing agent CLI. [File Writing](/guides/ori/files) explains what Ori puts in your project.
