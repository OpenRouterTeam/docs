...
canonicalUrl: https://openrouter.ai/docs/guides/routing/routers/auto-router
og:site_name: OpenRouter Documentation
og:title: 'Auto Router - Intelligent Model Selection'
og:description: "Automatically select the best AI model for your prompts using OpenRouter's Auto Router powered by NotDiamond."
