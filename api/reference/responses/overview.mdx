...
seoTitle: 'OpenRouter Responses API Beta'
canonicalUrl: https://openrouter.ai/docs/api/reference/responses/overview
...
og:image: https://openrouter.ai/dynamic-og?title=Responses%20API%20Beta&description=OpenAI-compatible%20stateless%20API
og:image:width: 1200
og:image:height: 630
