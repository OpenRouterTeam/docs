...
| `admin-utils/delete-logs/`         | GDPR/DSR log deletion by generation ID, API key, or Clerk organization — batched preview scan and deletion paginate in small pages to stay under the 30s server-action timeout, terminating only on an empty page                                                                                                                              |
