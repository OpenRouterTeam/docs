...
The second and final required meeting. It covers [provider routing](/guides/routing/provider-selection), [model fallbacks](/guides/routing/model-fallbacks), [prompt caching](/guides/best-practices/prompt-caching), [presets](/guides/features/presets) so your application code names use cases rather than model versions, [Broadcast](/guides/features/broadcast) into your own observability stack, [user attribution](/cookbook/administration/user-tracking), and access to the [Analytics API (beta)](/api/api-reference/betaanalytics/query-analytics-data) for your own reporting. Create presets from the [Presets](https://openrouter.ai/workspaces/default/presets) page.
