...
canonicalUrl: https://openrouter.ai/docs/cookbook/evaluate-and-optimize/model-migrations/gpt-5-4
og:site_name: OpenRouter Documentation
og:title: 'GPT-5.4 Migration Guide'
og:description: >-
  Learn how to use the phase field for GPT-5.3 Codex,
  GPT-5.4, and GPT-5.4 Pro on OpenRouter.
og:image: https://openrouter.ai/dynamic-og?title=GPT-5.4%20Migration%20Guide&description=Phase%20field%20support%20for%20GPT-5.3%20Codex%2C%20GPT-5.4%2C%20and%20GPT-5.4%20Pro
og:image:width: 1200
og:image:height: 630
