---
title: GPT-6 Astra Migration Guide
description: Adopt async tool calling and mid-conversation reasoning effort changes with configuration_update for GPT-6 Astra
seoTitle: "GPT-6 Astra Migration Guide | OpenRouter"
og:site_name: OpenRouter Documentation
og:title: "GPT-6 Astra Migration Guide"
og:description: >-
  ...
  safety policy blocks on GPT-6 Astra across the Chat Completions,
  Responses, and Anthropic Messages APIs on OpenRouter.
og:image: https://openrouter.ai/dynamic-og?title=GPT-6%20Astra%20Migration%20Guide&description=Async%20tool%20calling%20and%20mid-conversation%20reasoning%20effort
og:image:width: 1200
og:image:height: 630
