...
description: Adopt mid-conversation reasoning effort changes with configuration_update for GPT-6 Astra
seoTitle: "GPT-6 Astra Migration Guide | OpenRouter"
og:site_name: OpenRouter Documentation
og:title: "GPT-6 Astra Migration Guide"
og:description: >-
  Learn how to change reasoning effort mid-conversation with
  configuration_update on GPT-6 Astra across the Chat Completions,
  Responses, and Anthropic Messages APIs on OpenRouter.
og:image: https://openrouter.ai/dynamic-og?title=GPT-6%20Astra%20Migration%20Guide&description=Mid-conversation%20reasoning%20effort%20with%20configuration_update
og:image:width: 1200
og:image:height: 630
...
4. Keep every update at its original position when you replay history, and never place two updates back to back.
