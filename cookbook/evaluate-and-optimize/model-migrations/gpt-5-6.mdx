...
The fields work in both the [Chat Completions](/api/api-reference/chat/create-a-chat-completion) and [Responses](/api/api-reference/responses/create-a-response) APIs.
