...
The fields work in both the [Chat Completions](/api/api-reference/chat/create-a-chat-completion) and [Responses](/api/api-reference/betaresponses/create-a-response) APIs.
...
- [OpenRouter Responses API](/api/api-reference/betaresponses/create-a-response)
