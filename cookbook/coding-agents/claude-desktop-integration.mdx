...
canonicalUrl: https://openrouter.ai/docs/cookbook/coding-agents/claude-desktop-integration
...
<Frame>
![Claude Desktop third-party inference configuration panel showing Gateway selected with OpenRouter credentials](/assets/cookbook/coding-agents/claude-desktop-integration/claude-desktop-gateway-credentials.png)
</Frame>
