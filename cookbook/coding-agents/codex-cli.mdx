...
Using Codex inside the ChatGPT desktop app instead? See the [Codex Desktop App guide](/cookbook/coding-agents/codex-desktop), which covers making your API key visible to a GUI app.
