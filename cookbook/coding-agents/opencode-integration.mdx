...
canonicalUrl: https://openrouter.ai/docs/cookbook/coding-agents/opencode-integration
og:site_name: OpenRouter Documentation
og:title: 'OpenCode Integration - OpenRouter'
og:description: 'Learn how to configure OpenCode to use OpenRouter for agentic coding with access to hundreds of AI models.'
