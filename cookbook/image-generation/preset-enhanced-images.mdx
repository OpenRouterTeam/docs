...
<Info>
The response shown above is abbreviated. The full response includes additional fields like `workspace_id`, `description`, and timestamps. See the [Presets API reference](https://openrouter.ai/docs/client-sdks/typescript/sdks/presets/README) for the complete schema.
</Info>
