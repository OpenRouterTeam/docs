...
|---|---|
| ![Bare prompt result: generic watermelon-textured hippo on white background](/assets/cookbook/image-generation/bare-prompt-watermelon-hippo.png) | ![Enhanced prompt result: photorealistic watermelon hippo sculpture standing in a river at golden hour](/assets/cookbook/image-generation/enhanced-prompt-watermelon-hippo.png) |
...
<Info>
The response shown above is abbreviated. The full response includes additional fields like `workspace_id`, `description`, and timestamps. See the [Presets API reference](https://github.com/OpenRouterTeam/typescript-sdk/blob/main/docs/sdks/presets/README.mdx) for the complete schema.
</Info>
...
- Use the [OpenRouter TypeScript SDK](https://github.com/OpenRouterTeam/typescript-sdk) or [Python SDK](https://github.com/OpenRouterTeam/python-sdk) for typed preset interactions in your app
