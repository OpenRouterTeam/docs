...
- Responses request API, if this app uses Responses: https://openrouter.ai/docs/api/api-reference/betaresponses/create-a-response
- TypeScript SDK Chat reference, if this app uses @openrouter/sdk: https://github.com/OpenRouterTeam/typescript-sdk/blob/main/docs/sdks/chat/README.mdx
- TypeScript SDK Responses reference, if this app uses @openrouter/sdk beta responses: https://github.com/OpenRouterTeam/typescript-sdk/blob/main/docs/sdks/responses/README.mdx
...
- [Create a response](/api/api-reference/betaresponses/create-a-response)
- [TypeScript SDK Chat reference](https://github.com/OpenRouterTeam/typescript-sdk/blob/main/docs/sdks/chat/README.mdx)
