...
canonicalUrl: https://openrouter.ai/docs/agent-sdk/usage-for-agents
og:site_name: OpenRouter Documentation
og:title: 'Usage for Agents | OpenRouter Agent SDK'
og:description: >-
  Add OpenRouter Agent SDK skills to AI coding assistants like Claude Code, Cursor,
  GitHub Copilot, and more. Enable your AI to code with the OpenRouter Agent SDK.
og:image: >-
