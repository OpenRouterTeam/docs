...
canonicalUrl: https://openrouter.ai/docs/agent-sdk/overview
og:site_name: OpenRouter Documentation
og:title: 'Agent SDK | OpenRouter'
og:description: 'Build AI agents on OpenRouter with callModel, tool definitions, stop conditions, and automatic conversation state management.'
og:image: https://openrouter.ai/dynamic-og?pathname=agent-sdk&title=Agent%20SDK&description=Build%20AI%20agents%20with%20multi-turn%20loops%2C%20tools%2C%20and%20conversation%20state
og:image:width: 1200
og:image:height: 630
