...
seoTitle: ResponsesRequestToolUnion Type | OpenRouter TypeScript SDK
  https://openrouter.ai/docs/sdks/typescript/api-reference/models/responsesrequesttoolunion
'og:site_name': OpenRouter Documentation
'og:title': ResponsesRequestToolUnion Type | OpenRouter TypeScript SDK
'og:description': >-
  ResponsesRequestToolUnion type reference for the OpenRouter TypeScript SDK.
  Complete type definition and usage examples.
'og:image': >-
  https://openrouter.ai/dynamic-og?title=ResponsesRequestToolUnion%20-%20TypeScript%20SDK&description=ResponsesRequestToolUnion%20type%20definition
'og:image:width': 1200
'og:image:height': 630
