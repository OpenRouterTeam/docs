...
seoTitle: CreateWorkspaceResponse Type | OpenRouter TypeScript SDK
canonicalUrl: >-
  https://openrouter.ai/docs/sdks/typescript/api-reference/models/createworkspaceresponse
'og:site_name': OpenRouter Documentation
'og:title': CreateWorkspaceResponse Type | OpenRouter TypeScript SDK
'og:description': >-
  CreateWorkspaceResponse type reference for the OpenRouter TypeScript SDK.
  Complete type definition and usage examples.
'og:image': >-
  https://openrouter.ai/dynamic-og?title=CreateWorkspaceResponse%20-%20TypeScript%20SDK&description=CreateWorkspaceResponse%20type%20definition
'og:image:width': 1200
'og:image:height': 630
