...
seoTitle: ProviderOptions Type | OpenRouter TypeScript SDK
  https://openrouter.ai/docs/sdks/typescript/api-reference/models/provideroptions
'og:site_name': OpenRouter Documentation
'og:title': ProviderOptions Type | OpenRouter TypeScript SDK
'og:description': >-
  ProviderOptions type reference for the OpenRouter TypeScript SDK. Complete
  type definition and usage examples.
'og:image': >-
  https://openrouter.ai/dynamic-og?title=ProviderOptions%20-%20TypeScript%20SDK&description=ProviderOptions%20type%20definition
'og:image:width': 1200
'og:image:height': 630
